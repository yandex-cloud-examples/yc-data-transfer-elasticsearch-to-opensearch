# Infrastructure for the standalone Elasticsearch cluster, the Managed Service for OpenSearch cluster, and Data Transfer
#
...
locals {
  # Standalone Elasticsearch cluster settings:
  ...
  transfer_name         = "es-mos-transfer"    # Name of the transfer from the Elasticsearch cluster to the Managed Service for OpenSearch cluster
}
...
resource "yandex_managed_opensearch" {
...
resource "yandex_datatransfer_transfer" "es-mos-transfer" {
  count       = local.transfer_enabled
  description = "Transfer from the Elasticsearch cluster to the Managed Service for OpenSearch cluster"
